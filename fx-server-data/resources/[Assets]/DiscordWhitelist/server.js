...
var botToken = "OTUzMTM2NjY0ODQ5NTcxODYw.YjALsQ.oOiCrQTcOdqmdEvuY7GdAxuiHkI"; // This must be a Discord bot token, create a bot @ https://discord.com/developers/applications
...
var notWhitelistedMessage = "You are not whitelisted - Join at discord.gg/rpfrog";
var noGuildMessage = "Guild Not Detected. It seems you're not in the guild for this community.";
var blacklistMessage = "You are banned from RPFrogs.";
var debugMode = true; // 
...
on('playerConnecting', async (name, setKickReason, deferrals) => {
    ...
    deferrals.defer();
    setTimeout(() => {
        deferrals.update(`Hello ${name}. Checking against whitelist...`)
