...
AddEventHandler("drp-jobmanager:playerBecameJob", function(jobpassed, name, notify)
	job = jobpassed
    if not job then
        job = "None"
    end
...
AddEventHandler('drp-base:addedMoney', function(blah,amount)
  cash = math.ceil(amount)
end)

RegisterNetEvent('drp-base:removedMoney')
AddEventHandler('drp-base:removedMoney', function(blah,amount)
  cash = math.ceil(amount)
end)
...
RegisterNetEvent('drp-phone:fix-dead')
AddEventHandler('drp-phone:fix-dead', function()
  dead = false
end)