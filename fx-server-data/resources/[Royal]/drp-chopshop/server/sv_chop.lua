...
AddEventHandler("drp-chopshop:vehicle_loot", function(string)
    ...
    if string == "tyre" then
        TriggerClientEvent("player:receiveItem", src, "recyclablematerial", math.random(5, 9), false)
    elseif string == "door" then
        TriggerClientEvent("player:receiveItem", src, "recyclablematerial", math.random(7, 11), false)
