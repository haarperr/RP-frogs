...
local KnownWeapons = {
    ...
    [2132975508] = {['weaponName'] = 'SA-80', ['isAuto'] = true},
}
    ...
    if math.random(10) > 5 and not isInVehicle then
        CreateThread(function()
            ...
            if IsPedInAnyVehicle(PlayerPedId()) then
                ...
                TriggerServerEvent('drp-dispatch:combatAlert', newPos)
            end
            return
        end)
    end
...
RegisterNetEvent('drp-mdt:drugsale')
AddEventHandler("drp-mdt:drugsale",function()
    DrugSale()
end)
...
function CarCrash()
    ...
    TriggerServerEvent('drp-dispatch:vehiclecrash', currentPos)
    TriggerServerEvent('dispatch:svNotify', {
        dispatchCode = dispatchCode,
        firstStreet = locationInfo,
        gender = gender,
...
function AlertCheckLockpick(object)
    ...
    TriggerEvent('drp-dispatch:stolenveh')
    TriggerServerEvent('dispatch:svNotify', {
        dispatchCode = initialTenCode,
        firstStreet = locationInfo,
        gender = gender,
...
RegisterNetEvent('drp-dispatch:houserobbery')
AddEventHandler("drp-dispatch:houserobbery",function()
    AlertHouseRobbery()
end)
...
function AlertHouseRobbery()
    ...
    TriggerEvent('drp-dispatch:robhouse')
    TriggerServerEvent('dispatch:svNotify', {
        dispatchCode = dispatchCode,
        firstStreet = locationInfo,
        gender = gender,
...
function AlertJewelRob()
    ...
    TriggerServerEvent('drp-dispatch:jewel', currentPos)
    TriggerServerEvent('dispatch:svNotify', {
        dispatchCode = dispatchCode,
        firstStreet = locationInfo,
        gender = gender,
    ...
    if math.random(10) > 2 and not isInVehicle then
        CreateThread(function()
            ...
            if IsPedInAnyVehicle(PlayerPedId()) then
                ...
                TriggerServerEvent('drp-dispatch:jewel', newPos)
            end
            return
        end)
    end
...
function AlertJailBreak()
    ...
    TriggerServerEvent('drp-dispatch:blip:jailbreak', currentPos)
    TriggerServerEvent('dispatch:svNotify', {
        dispatchCode = dispatchCode,
        firstStreet = locationInfo,
        gender = gender,
    ...
    if math.random(10) > 2 and not isInVehicle then
        CreateThread(function()
            ...
            if IsPedInAnyVehicle(PlayerPedId()) then
                ...
                TriggerServerEvent('drp-dispatch:blip:jailbreak', newPos)
            end
            return
        end)
    end
...
RegisterNetEvent('drp-dispatch:bankrobbery:pacific')
AddEventHandler("drp-dispatch:bankrobbery:pacific",function()
    AlertPacificRobbery()
end)
...
function AlertDeath()
    ...
    TriggerEvent('drp-dispatch:downguy')
    TriggerServerEvent('dispatch:svNotify', {
        dispatchCode = dispatchCode,
        firstStreet = locationInfo,
        gender = gender,
...
RegisterNetEvent('drp-dispatch:jewelrobbery')
AddEventHandler("drp-dispatch:jewelrobbery",function()
    AlertJewelRob()
end)

RegisterNetEvent('drp-dispatch:carjacking')
AddEventHandler("drp-dispatch:carjacking",function()
    AlertCheckLockpick()
end)
...
LoadRoyalVersion = function()
    ...
    RegisterNetEvent('drp-dispatch:setBlip')
    AddEventHandler('drp-dispatch:setBlip', function(type, pos, id)
        ...
        for i,v in ipairs(gasStations) do
            ...
            if scandst < 20 and scandst < dstcheck then
                ...
                if IsExplosionInSphere(9,v[1],v[2],v[3],60.0)  then
                    ...
                    TriggerEvent('drp-dispatch:gasexplosion')
                    Wait(9000)
                    origin3 = false
                end
            end
...
RegisterNetEvent('drp-dispatch:storerobbery2')
...
function AlertShop()
    ...
    TriggerEvent('drp-dispatch:robstore')
    TriggerServerEvent('dispatch:svNotify', {
        dispatchCode = dispatchCode,
        firstStreet = locationInfo,
        gender = gender,
...
RegisterNetEvent('drp-dispatch:bank_truck_robbery')
AddEventHandler("drp-dispatch:bank_truck_robbery",function()
    AlertBankTruck()
end)
...
function AlertBankTruck()
    ...
    local currentVeh = GetVehiclePedIsIn(PlayerPedId(), false)
    local dispatchCode = "10-90"
    TriggerEvent('drp-dispatch:bankt')
    TriggerServerEvent('dispatch:svNotify', {
        dispatchCode = dispatchCode,
        firstStreet = locationInfo,
        gender = gender,
