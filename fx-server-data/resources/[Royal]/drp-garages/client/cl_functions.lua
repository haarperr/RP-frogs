...
function SpawnVehicle(vehicle, pGarage, Fuel, customized, plate, IsViewing, engine_damage, body_damage)
    ...
    elseif exports['drp-menu']:houseGarageCoords() ~= nil and exports['drp-menu']:NearHouseGarage() then
        HousingSpawn = exports['drp-menu']:houseGarageCoords()
	...
	Citizen.CreateThread(function()			
        ...
        if not IsViewing then    
            CurrentDisplayVehicle = nil
            RPC.execute("drp-garages:states", "Out", plate, exports['drp-menu']:currentGarage(), pUpdatedFuel, enginehealth, bodyhealth)
        end
    end)
end
