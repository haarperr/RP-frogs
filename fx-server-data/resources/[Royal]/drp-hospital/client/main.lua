...
function LeaveBed()
    ...
    TriggerServerEvent('drp-hospital:server:LeaveBed', bedOccupying)
...
RegisterNetEvent('drp-hospital:client:RPCheckPos')
AddEventHandler('drp-hospital:client:RPCheckPos', function()
    TriggerServerEvent('drp-hospital:server:RPRequestBed', GetEntityCoords(PlayerPedId()))
end)

RegisterNetEvent('drp-hospital:client:RPSendToBed')
AddEventHandler('drp-hospital:client:RPSendToBed', function(id, data)
    bedOccupying = id
...
RegisterNetEvent('drp-hospital:client:SendToBed')
AddEventHandler('drp-hospital:client:SendToBed', function(id, data)
    bedOccupying = id
    bedOccupyingData = data
    ...
    Citizen.CreateThread(function ()
        ...
        TriggerServerEvent('drp-hospital:server:EnteredBed')
    end)
end)

RegisterNetEvent('drp-hospital:client:FinishServices')
AddEventHandler('drp-hospital:client:FinishServices', function()
