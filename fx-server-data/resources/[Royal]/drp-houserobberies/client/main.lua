			...
			if distancia < 3 and isnight() then
				...
				exports['drp-textui']:showInteraction('[H] To Enter House')
					if IsControlJustReleased(0,74) and distancia < 3 and firstentry then
						...
						if exports['drp-inventory']:hasEnoughOfItem('advlockpick', 1) then
							local finished = exports["drp-ui"]:taskBarSkill(math.random(1000, 2500),math.random(40, 100))
							if (finished == 100) then
								local finished2 = exports["drp-ui"]:taskBarSkill(math.random(1000, 2500),math.random(40,100))
								if (finished2 == 100) then
									local finished3 = exports["drp-ui"]:taskBarSkill(math.random(1000, 2500),math.random(40,100))
									if (finished3 == 100) then
										local finished4 = exports["drp-ui"]:taskBarSkill(math.random(1000, 2500),math.random(40,100))
