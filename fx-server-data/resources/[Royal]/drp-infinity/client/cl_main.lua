...
TriggerServerEvent("rrp:infinity:player:ready")

RegisterNetEvent('rrp:infinity:player:coords')
AddEventHandler('rrp:infinity:player:coords', function (pCoords)
    PlayerCoords = pCoords
end)

RegisterNetEvent('rrp:infinity:entity:coords')
AddEventHandler('rrp:infinity:entity:coords', function (pNetId, pCoords)
...
function FetchEntityCoords(pNetId)
    ...
    TriggerServerEvent('rrp:infinity:entity:coords', pNetId)
