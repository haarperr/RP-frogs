...
--         isEnabled = function(pEntity, pContext)
--             return exports['drp-interact']:NearGasFn()
--         end
--     }
-- }
    ...
    data = {
        {
            ...
            label = "Refuel Vehicle",
            icon = "gas-pump",
            event = "drp-hud:jerry_can:refuel",
            parameters = {}
        }
    },
    options = {
    ...
    data = {
        {
            ...
            icon = "wheelchair",
            event = "royal:vehicle:wheelchair:control",
            parameters = {}
        }
    },
    options = {
    ...
    data = {
        {
            ...
            event = "drp-jobs:sanitationWorker:vehicleTrash",
            parameters = {}
        }
    },
    options = {
    ...
    data = {
        {
            ...
            label = "Grab goods",
            icon = "box",
            event = "drp-jobs:247delivery:takeGoods",
            parameters = {}
        }
    },
    options = {
...
--             and exports["drp-inventory"]:hasEnoughOfItem("thermitecharge", 1, false, true)
--       end
--   }
-- }
