...
RegisterNetEvent('drp-fishing:start')
AddEventHandler('drp-fishing:start', function()
    if exports['drp-inventory']:hasEnoughOfItem('fishingrod', 1) then
        TriggerEvent('DoLongHudText', 'Select A Zone', 1)
        TriggerEvent('drp-civjobs:fishing_select_zone')
    else
        TriggerEvent('DoLongHudText', 'You are not equipped to go and fish come back when you are', 2)
    end
end)

RegisterNetEvent('drp-fishing:stop')
AddEventHandler('drp-fishing:stop', function()
...
RegisterNetEvent('drp-fishing:start-fishing')
AddEventHandler('drp-fishing:start-fishing', function()
...
Citizen.CreateThread(function()
    exports["drp-polyzone"]:AddBoxZone("fishing_zone_1", vector3(1641.0, 3881.09, 37.92), 250.6, 35.4, {
        name="fishing_zone_1",
        heading=305,
        debugPoly=false
    })
...
Citizen.CreateThread(function()
    exports["drp-polyzone"]:AddBoxZone("fishing_zone_2", vector3(1306.75, 4252.16, 33.91), 75, 6.6, {
        name="fishing_zone_2",
        heading=350,
        --debugPoly=true,
        minZ=32.71,
...
Citizen.CreateThread(function()
    exports["drp-polyzone"]:AddBoxZone("fishing_zone_3", vector3(714.04, 4122.83, 35.78), 75, 67.0, {
        name="fishing_zone_3",
        heading=0,
        --debugPoly=true
    })
...
Citizen.CreateThread(function()
    exports["drp-polyzone"]:AddBoxZone("fishing_zone_4", vector3(-187.49, 4139.61, 34.98), 75, 25.2, {
        name="fishing_zone_4",
        heading=320,
        --debugPoly=true
    })
...
Citizen.CreateThread(function()
    exports["drp-polyzone"]:AddBoxZone("fishing_zone_5", vector3(397.93, 3624.15, 33.21), 75, 19.8, {
        name="fishing_zone_5",
        heading=265,
        -- debugPoly=true,
        minZ=31.21,
...
function setFishingPed()
    ...
    created_ped = CreatePed(0, modelHash , 1530.3297119141, 3778.4174804688, 34.503295898438  -1, true)
...
RegisterNetEvent('drp-fishing:sell')
AddEventHandler('drp-fishing:sell', function()
...
AddEventHandler("fishing:sell1", function()
	if exports["drp-inventory"]:getQuantity("fishingbass") >= 1 then
		...
		local finished = exports["drp-taskbar"]:taskBar(1000*fishToSell, "Selling "+ tostring(fishToSell) + " Bass",true,false,playerVeh)
...
AddEventHandler("fishing:sell2", function()
    if exports["drp-inventory"]:getQuantity("fishingsockeyesalmon") >= 1 then
		...
		local finished = exports["drp-taskbar"]:taskBar(1000*fishToSell, "Selling "+ tostring(fishToSell) + " Salmon",true,false,playerVeh)
		if finished == 100 then
			if exports["drp-inventory"]:getQuantity("fishingsockeyesalmon") >= 1 then
				ClearPedTasksImmediately(PlayerPedId())
...
AddEventHandler("fishing:sell3", function()
    if exports["drp-inventory"]:getQuantity("fishingmackerel") >= 1 then
		playerAnim()
        local fishToSell = exports["drp-inventory"]:getAmountOfItem("fishingsockeyesalmon")
		local finished = exports["drp-taskbar"]:taskBar(1500*fishToSell, "Selling "+ tostring(fishToSell) + " Mackerel",true,false,playerVeh)
		if finished == 100 then
			if exports["drp-inventory"]:getQuantity("fishingmackerel") >= 1 then
				ClearPedTasksImmediately(PlayerPedId())
...
AddEventHandler("fishing:sell4", function()
    if exports["drp-inventory"]:getQuantity("fishingshark") >= 1 then
		...
		local finished = exports["drp-taskbar"]:taskBar(10000*fishToSell, "Selling "+ tostring(fishToSell) + " Shark",true,false,playerVeh)
		if finished == 100 then
			if exports["drp-inventory"]:getQuantity("fishingshark") >= 1 then
				ClearPedTasksImmediately(PlayerPedId())
...
AddEventHandler("fishing:sell5", function()
    if exports["drp-inventory"]:getQuantity("fishingdolphin") >= 1 then
		...
		local finished = exports["drp-taskbar"]:taskBar(10000*fishToSell, "Selling " + tostring(fishToSell) + " Dolphin",true,false,playerVeh)
		if finished == 100 then
			if exports["drp-inventory"]:getQuantity("fishingdolphin") >= 1 then
				ClearPedTasksImmediately(PlayerPedId())
...
AddEventHandler("fishing:sell6", function()
    if exports["drp-inventory"]:getQuantity("fishingwhale") >= 1 then
		...
		local finished = exports["drp-taskbar"]:taskBar(10000*fishToSell, "Selling "+ tostring(fishToSell) + " Whale",true,false,playerVeh)
		if finished == 100 then
			if exports["drp-inventory"]:getQuantity("fishingwhale") >= 1 then
				ClearPedTasksImmediately(PlayerPedId())
...
RegisterNetEvent('drp-civjobs:fishing_select_zone')
AddEventHandler('drp-civjobs:fishing_select_zone', function()
    TriggerEvent('drp-context:sendMenu', {
        {
            id = 1,
        ...
        },
        {
            ...
            params = {
                event = "drp-fishing:select_zone_1"
            }
        },
        {
            id = 3,
            ...
            params = {
                event = "drp-fishing:select_zone_2"
            }
        },
        {
            id = 4,
            ...
            params = {
                event = "drp-fishing:select_zone_3"
            }
        },
        {
            id = 5,
            ...
            params = {
                event = "drp-fishing:select_zone_4"
            }
        },
        {
            id = 6,
            ...
            params = {
                event = "drp-fishing:select_zone_5"
            }
        },
    })
end)

RegisterNetEvent('drp-fishing:select_zone_1')
AddEventHandler('drp-fishing:select_zone_1', function()
...
RegisterNetEvent('drp-fishing:select_zone_2')
AddEventHandler('drp-fishing:select_zone_2', function()
    fishinglocation2active = true
    SetNewWaypoint(1311.7054443359, 4279.0419921875)
    TriggerEvent('DoLongHudText', 'Your GPS was updated go to the area and fish', 1)
end)

RegisterNetEvent('drp-fishing:select_zone_3')
AddEventHandler('drp-fishing:select_zone_3', function()
    fishinglocation3active = true
    SetNewWaypoint(714.23736572266, 4148.9936523438)
    TriggerEvent('DoLongHudText', 'Your GPS was updated go to the area and fish', 1)
end)

RegisterNetEvent('drp-fishing:select_zone_4')
AddEventHandler('drp-fishing:select_zone_4', function()
    fishinglocation4active = true
    SetNewWaypoint(-183.74505615234, 4140.6328125)
    TriggerEvent('DoLongHudText', 'Your GPS was updated go to the area and fish', 1)
end)

RegisterNetEvent('drp-fishing:select_zone_5')
AddEventHandler('drp-fishing:select_zone_5', function()
