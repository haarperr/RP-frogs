...
RegisterNetEvent('drp-jobs:red-circle-shop')
AddEventHandler('drp-jobs:red-circle-shop', function()
...
RegisterNetEvent('drp-jobs:red-circle-fridge')
AddEventHandler('drp-jobs:red-circle-fridge', function()
...
RegisterNetEvent('drp-jobs:redcircle:MakeDrink')
AddEventHandler('drp-jobs:redcircle:MakeDrink', function(args)
    ...
    if rank > 0 then 
        TriggerEvent('drp-context:sendMenu', {
            ...
            },
            {
                ...
                params = {
                    event = "drp-jobs:redcircle:MakeDrink",
                    args = {
                        items1 = 'vodka',
                        items2 = 'lime',
                        items3 = 'watermelon',
...
Citizen.CreateThread(function()
    exports["drp-polyzone"]:AddBoxZone("red_circle_stash", vector3(-320.67, 192.31, 104.09), 0.7, 2.35, {
...
RegisterNetEvent('drp-jobs:red-circle_seat_vip_1')
AddEventHandler('drp-jobs:red-circle_seat_vip_1', function()
...
RegisterNetEvent('drp-jobs:red-circle_seat_vip_2')
AddEventHandler('drp-jobs:red-circle_seat_vip_2', function()
    SetEntityHeading(GetPlayerPed(-1), 289.13385009766)
    SetEntityCoords(PlayerPedId(), -310.9186706543,186.777777,103.02000065625)
    TriggerEvent('animation:Chair2')
end)

RegisterNetEvent('drp-jobs:red-circle_seat_vip_3')
AddEventHandler('drp-jobs:red-circle_seat_vip_3', function()
...
RegisterNetEvent('drp-jobs:red-circle_seat_vip_4')
AddEventHandler('drp-jobs:red-circle_seat_vip_4', function()
...
RegisterCommand('ay', function()
    TriggerEvent('drp-jobs:red-circle_seat_vip_4')
end)
...
RegisterNetEvent("drp-jobs:red_circle-table-1")
AddEventHandler("drp-jobs:red_circle-table-1", function()
    TriggerEvent("server-inventory-open", "1", "redcircle_table_1_vip");
end)

RegisterNetEvent("drp-jobs:red_circle-table-2")
AddEventHandler("drp-jobs:red_circle-table-2", function()
    TriggerEvent("server-inventory-open", "1", "redcircle_table_1_vip");
end)

-- Regular

RegisterNetEvent("drp-jobs:red_circle-table-3")
AddEventHandler("drp-jobs:red_circle-table-3", function()
    TriggerEvent("server-inventory-open", "1", "redcircle_table_3");
end)

RegisterNetEvent("drp-jobs:red_circle-table-4")
AddEventHandler("drp-jobs:red_circle-table-4", function()
    TriggerEvent("server-inventory-open", "1", "redcircle_table_4");
end)

RegisterNetEvent("drp-jobs:red_circle-table-5")
AddEventHandler("drp-jobs:red_circle-table-5", function()
    TriggerEvent("server-inventory-open", "1", "redcircle_table_5");
end)

RegisterNetEvent("drp-jobs:red_circle-table-6")
AddEventHandler("drp-jobs:red_circle-table-6", function()
    TriggerEvent("server-inventory-open", "1", "redcircle_table_6");
end)

RegisterNetEvent("drp-jobs:red_circle-table-7")
AddEventHandler("drp-jobs:red_circle-table-7", function()
    TriggerEvent("server-inventory-open", "1", "redcircle_table_7");
end)

RegisterNetEvent("drp-jobs:red_circle-table-8")
AddEventHandler("drp-jobs:red_circle-table-8", function()
...
-- Booth 1 Start
RegisterNetEvent("drp-jobs:red_circle-booth-1-table-1")
AddEventHandler("drp-jobs:red_circle-booth-1-table-1", function()
    TriggerEvent("server-inventory-open", "1", "redcircle_booth_1_table_1");
end)

RegisterNetEvent("drp-jobs:red_circle-booth-1-table-2")
AddEventHandler("drp-jobs:red_circle-booth-1-table-2", function()
    TriggerEvent("server-inventory-open", "1", "redcircle_booth_1_table_2");
end)
-- Booth 1 End

-- Booth 2 Start
RegisterNetEvent("drp-jobs:red_circle-booth-2-table-1")
AddEventHandler("drp-jobs:red_circle-booth-2-table-1", function()
    TriggerEvent("server-inventory-open", "1", "redcircle_booth_2_table_1");
end)

RegisterNetEvent("drp-jobs:red_circle-booth-2-table-2")
AddEventHandler("drp-jobs:red_circle-booth-2-table-2", function()
    TriggerEvent("server-inventory-open", "1", "redcircle_booth_2_table_2");
end)
-- Booth 2 End

-- Booth 3 Start
RegisterNetEvent("drp-jobs:red_circle-booth-3-table-1")
AddEventHandler("drp-jobs:red_circle-booth-3-table-1", function()
    TriggerEvent("server-inventory-open", "1", "redcircle_booth_3_table_1");
end)

RegisterNetEvent("drp-jobs:red_circle-booth-3-table-2")
AddEventHandler("drp-jobs:red_circle-booth-3-table-2", function()
    TriggerEvent("server-inventory-open", "1", "redcircle_booth_3_table_2");
end)
-- Booth 3 End

-- Booth 4 Start
RegisterNetEvent("drp-jobs:red_circle-booth-4-table-1")
AddEventHandler("drp-jobs:red_circle-booth-4-table-1", function()
    TriggerEvent("server-inventory-open", "1", "redcircle_booth_4_table_1");
end)

RegisterNetEvent("drp-jobs:red_circle-booth-4-table-2")
AddEventHandler("drp-jobs:red_circle-booth-4-table-2", function()
...
RegisterNetEvent('drp-jobs:red-circle:main-floor:elevator_go_up')
AddEventHandler('drp-jobs:red-circle:main-floor:elevator_go_up', function()
    local job = exports["isPed"]:GroupRank('red_circle')
    if job >= 3 then
        local finished = exports['drp-taskbar']:taskBar(5000, 'Calling Elevator')
        if (finished == 100) then
...
RegisterNetEvent('drp-jobs:red-circle:main-floor:elevator_go_down')
AddEventHandler('drp-jobs:red-circle:main-floor:elevator_go_down', function()
    local job = exports["isPed"]:GroupRank('red_circle')
    if job >= 3 then
        local finished = exports['drp-taskbar']:taskBar(5000, 'Calling Elevator')
        if (finished == 100) then
