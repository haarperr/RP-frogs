...
const load = Vue.createApp({
  setup () {
    return {
      ...
      DownloadTitle: 'Downloading Server Files',
      DownloadDesc: "Hold on while we still downloading all the resources needed to play in RPFrogs. \n\nOnce the download is successfully completed, you will be placed on the server and this screen will disappear. Please do not leave or turn off your PC.",

      SettingsTitle: 'Settings',
      AudioTrackDesc1: 'Background Music Toggle',
