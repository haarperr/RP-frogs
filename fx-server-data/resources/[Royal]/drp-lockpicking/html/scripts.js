  ...
  function outOfPins() {
      $.post('http://drp-lockpicking/failure', JSON.stringify({}));
      gameOver = true;
  ...
  function unlock() {
      $.post('http://drp-lockpicking/complete', JSON.stringify({}));
      playSound("lockUnlocked", 0.1)
      gameOver = true;
  ...
  document.onkeyup = function(data) {
      if (data.which == 27) {
          $.post('http://drp-lockpicking/close', JSON.stringify({}));
      }
  };