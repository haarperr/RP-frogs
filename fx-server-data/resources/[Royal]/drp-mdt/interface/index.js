...
$(document).ready(() => {
    ...
    $(".profile-items").on("click", ".profile-item", function () {
        let id = $(this).data("id");
        $.post('https://drp-mdt/getProfileData', JSON.stringify({
            id: id
        }));
    })
    ...
    $(".bulletin-items-continer").on("keydown", ".bulletin-item", function (e) {
        if (e.keyCode === 13) {
            ...
            let time = new Date()
            $.post('https://drp-mdt/newBulletin', JSON.stringify({
                title: title,
                info: info,
                time: time.getTime()
            }));
    ...
    $(".contextmenu").on("click", ".remove-bulletin", function () {
        ...
        $.post('https://drp-mdt/deleteBulletin', JSON.stringify({
            id: BulletinId,
            time: time.getTime()
        }));
        ...
        if (e.keyCode === 13) {
            ...
            if (URL !== "") {
                ...
                setTimeout(() => {
                    ...
                    $.post('https://drp-mdt/addGalleryImg', JSON.stringify({
                        cid: cid,
                        URL: URL
                    }));
                }, 250);
    ...
    $(".manage-profile-save").click(function () {
        if (canSaveProfile == true) {
            ...
            setTimeout(() => {
                ...
                $.post('https://drp-mdt/saveProfile', JSON.stringify({
                    pfp: pfp,
            ...
            setTimeout(() => {
                if (canRefreshIncidents == true) {
                    ...
                    setTimeout(() => {
                        ...
                        $.post('https://drp-mdt/getAllIncidents', JSON.stringify({}));
                    }, 1500);
                }
            }, 1000);
    ...
    $(".contextmenu").on("click", ".search-vehicle", function () {
       ...
       setTimeout(() => {
           ...
           setTimeout(() => {
               ...
               $.post('https://drp-mdt/searchVehicles', JSON.stringify({
                   name: plate.toString()
               }));
               $(".dmv-items").empty();
                $('.dmv-items').prepend(`<div class="profile-loader"></div>`);
               setTimeout(() => {
                   $.post('https://drp-mdt/getVehicleData', JSON.stringify({
    ...
    $(".contextmenu").on("click", ".search-weapon", function () {
        ...
        setTimeout(() => {
            ...
            setTimeout(() => {
                ...
                $.post('https://drp-mdt/searchWeapon', JSON.stringify({
                    name: plate.toString()
                }));
                $(".weapons-items").empty();
                $('.weapons-items').prepend(`<div class="profile-loader"></div>`);
                setTimeout(() => {
                    $.post('https://drp-mdt/getWeaponData', JSON.stringify({
    ...
    $(".contextmenu").on("click", ".revoke-licence", function () {
        if (pJob == 'police' || pJob == 'state' || pJob == 'sheriff') {
            $.post('https://drp-mdt/updateLicence', JSON.stringify({
    ...
    $('#profile-search-input').keydown(function (e) {
        if (e.keyCode === 13 && canSearchForProfiles == true) {
            ...
            if (name !== "") {
                ...
                $.post('https://drp-mdt/searchProfiles', JSON.stringify({
                    name: name
                }));
                $(".profile-items").empty();
    ...
    $('#incidents-search-input').keydown(function (e) {
        if (e.keyCode === 13 && canSearchForProfiles == true) {
            ...
            if (incident !== "") {
                canSearchForProfiles = false
                $.post('https://drp-mdt/searchIncidents', JSON.stringify({
                    incident: incident
                }));
    ...
    $('#dispatchmsg').keydown(function (e) {
        ...
        if (keyCode === 13 && !e.shiftKey) {
            e.preventDefault()
            const time = new Date()
            $.post('https://drp-mdt/dispatchMessage', JSON.stringify({
                message: $(this).val(),
                time: time.getTime()
            }));
            $(this).val("")
    ...
    $(".incidents-items").on("click", ".incidents-item", function () {
        ...
        $.post('https://drp-mdt/getIncidentData', JSON.stringify({
            id: id
        }));
    })
    ...
    document.onkeyup = function (data) {
        if (data.which == 27) {
            ...
            if (shouldClose == true) {
                $.post('https://drp-mdt/escape', JSON.stringify({}));
            }
        }
    };
    ...
    $(".icidents-person-search-name-input").on("keydown", "", function (e) {
        if (e.keyCode === 13) {
            ...
            $.post('https://drp-mdt/incidentSearchPerson', JSON.stringify({
                name: name
            }));
        }
    });
    ...
    $(".manage-bolos-title-holder").on("click", ".manage-bolos-save", function () {
        ...
        $.post('https://drp-mdt/newBolo', JSON.stringify({
            existing: existing,
            id: id,
            title: title,
            plate: plate,
    ...
    $('#bolos-search-input').keydown(function (e) {
        if (e.keyCode === 13 && canSearchForProfiles == true) {
            ...
            if (searchVal !== "") {
                canSearchForProfiles = false
                $.post('https://drp-mdt/searchBolos', JSON.stringify({
                    searchVal: searchVal
                }));
                $(".bolos-items").empty();
    ...
    $(".bolos-search-refresh").click(function () {
        if (canRefreshBolo == true) {
            ...
            setTimeout(() => {
                ...
                canRefreshBolo = true
                $.post('https://drp-mdt/getAllBolos', JSON.stringify({}));
            }, 1500);
        }
    });
    ...
    $(".bolos-items").on("click", ".bolo-item", function () {
        ...
        canInputBoloOfficerTag = true
        let id = $(this).data("id");
        $.post('https://drp-mdt/getBoloData', JSON.stringify({
            id: id
        }));
    })
    ...
    $(".contextmenu").on("click", ".bolo-delete", function () { 
        ...
        if ($(this).data("info") != 0) {
            if ($(".badge-logo").attr('src') == 'https://i.imgur.com/B9zsyBj.png') {
                ...
                $.post('https://drp-mdt/deleteICU', JSON.stringify({
                id: $(this).data("info")
            }));
        }
        $(".bolos-items").find("[data-id='" + $(this).data("info") + "']").remove();
        $.post('https://drp-mdt/deleteBolo', JSON.stringify({
            id: $(this).data("info"),
    ...
    $(".contextmenu").on("click", ".incident-delete", function () { 
        ...
        $.post('https://drp-mdt/deleteIncident', JSON.stringify({
            id: $(this).data("info"),
            time: new Date().getTime()
        }));
    });
    ...
    $(".contextmenu").on("click", ".missing-delete", function () { 
        ...
        $.post('https://drp-mdt/deleteMissing', JSON.stringify({
            id: $(this).data("info"),
            time: new Date().getTime()
        }));
    });
    ...
    $(".contextmenu").on("click", ".profile-missing", function () { 
        $.post('https://drp-mdt/missingCitizen', JSON.stringify({
            cid: $(this).data("info"),
    ...
    $(".contextmenu").on("click", ".report-delete", function () { 
        ...
        $.post('https://drp-mdt/deleteReport', JSON.stringify({
            id: $(this).data("info"),
            time: new Date().getTime()
        }));
    });
    ...
    $(".contextmenu").on("click", ".add-charge", function () { 
        ...
        $.post('https://drp-mdt/getPenalCode', JSON.stringify({}));
    });
    ...
    $(".contextmenu").on("click", ".associated-incidents-remove-tag", function () { 
        ...
        if (incidentId != 0) {
            $.post('https://drp-mdt/removeIncidentCriminal', JSON.stringify({
    ...
    $(".contextmenu").on("click", ".incidents-remove-normal-tag", function () { 
        ...
        let cid = $(".manage-profile-citizenid-input").val();
        if (cid) {
            $.post('https://drp-mdt/removeProfileTag', JSON.stringify({
                cid: cid,
                text: $(this).data("info")
            }));
        }
    ...
    $(".reports-search-refresh").click(function () {
        if (canRefreshReports == true) {
            ...
            setTimeout(() => {
                ...
                $.post('https://drp-mdt/getAllReports', JSON.stringify({}));
            }, 1500);
        }
    });
    $(".dispatch-comms-refresh").click(function(){
        ...
        setTimeout(() => {
            ...
            canRefreshReports = true
            $.post('https://drp-mdt/refreshDispatchMsgs', JSON.stringify({}));
        }, 1500);
    })
    $(".reports-items").on("click", ".reports-item", function () {
        ...
        let id = $(this).data("id");
        $.post('https://drp-mdt/getReportData', JSON.stringify({
            id: id
        }));
    })
    ...
    $('#reports-search-input').keydown(function (e) {
        if (e.keyCode === 13 && canSearchForReports == true) {
            ...
            if (name !== "") {
                ...
                $.post('https://drp-mdt/searchReports', JSON.stringify({
                    name: name
                }));
                $(".reports-items").empty();
    ...
    $(".manage-reports-title-holder").on("click", ".manage-reports-save", function () {
        ...
        $.post('https://drp-mdt/newReport', JSON.stringify({
            existing: existing,
            id: id,
            title: title,
            type: type,
    ...
    $('#missing-search-input').keydown(function (e) {
        if (e.keyCode === 13) {
            ...
            if (name !== "") {
                $.post('https://drp-mdt/searchMissing', JSON.stringify({
                    name: name
                }));
                $(".missing-items").empty();
    ...
    $(".missing-items").on("click", ".missing-item", function () {
        $.post('https://drp-mdt/getMissingData', JSON.stringify({
            id: $(this).data("dbid")
        }));
    });
    ...
    $(".vehicle-information-title-holder").on("click", ".vehicle-information-save", function () {
        if (canSaveVehicle) {
            ...
            setTimeout(() => {
                ...
                $.post('https://drp-mdt/saveVehicleInfo', JSON.stringify({
                    dbid: dbid,
                    plate: plate,
                    imageurl: imageurl,
                    notes: notes
    ...
    $(".weapon-information-title-holder").on("click", ".weapon-information-save", function () {
        if (canSaveVehicle) {
            ...
            setTimeout(() => {
                ...
                $.post('https://drp-mdt/saveWeaponInfo', JSON.stringify({
                    dbid: dbid,
    ...
    $(".missing-information-title-holder").on("click", ".missing-information-save", function () {
        if (canSaveVehicle) {
            ...
            setTimeout(() => {
                ...
                $.post('https://drp-mdt/saveMissingInfo', JSON.stringify({
                    id: dbid,
                    imageurl: imageurl,
                    notes: notes
                }));
    ...
    $(".contextmenu").on("click", ".mark-code-5", function () { 
        ...
        if ( tag.hasClass("red-tag")) {
            ...
            $.post('https://drp-mdt/knownInformation', JSON.stringify({
    ...
    $(".contextmenu").on("click", ".set-waypoint", function () { 
        let info = $(this).data("info")
        $.post('https://drp-mdt/setWaypointU', JSON.stringify({
            cid: info,
        }));
    })
    ...
    $(".contextmenu").on("click", ".Set-Waypoint", function () { 
        ...
        $.post('https://drp-mdt/setWaypoint', JSON.stringify({
            callid: callId,
        }));
    })
    ...
    $(".contextmenu").on("click", ".call-attach", function () { 
        const callId = $(this).data("info")
        $.post('https://drp-mdt/callAttach', JSON.stringify({
            callid: callId,
        }));
    })
    ...
    $(".contextmenu").on("click", ".call-detach", function () { 
        const callId = $(this).data("info")
        $.post('https://drp-mdt/callDetach', JSON.stringify({
            callid: callId
        }));
    })
    ...
    $(".contextmenu").on("click", ".remove-call", function () { 
        ...
        $.post('https://drp-mdt/removeCall', JSON.stringify({
            callid: callId
        }));
    })
    ...
    $(".contextmenu").on("click", ".attached-units", function () { 
        const callId = $(this).data("info")
        $.post('https://drp-mdt/attachedUnits', JSON.stringify({
            callid: callId
        }));
    })
    ...
    $('#respondcalls').keydown(function (e) {
        ...
        if (keyCode === 13 && !e.shiftKey) {
            ...
            e.preventDefault();
            const time = new Date()
            $.post('https://drp-mdt/sendCallResponse', JSON.stringify({
                message: $(this).val(),
                time: time.getTime(),
                callid: callid
            }));
    ...
    $(".contextmenu").on("click", ".respond-call", function () {
        const callId = $(this).data("info")
        $.post('https://drp-mdt/getCallResponses', JSON.stringify({
            callid: callId
        }));
    ...
    $(".contextmenu").on("click", ".call-dispatch-detach", function () { 
        const cid = $(this).data("info")
        $.post('https://drp-mdt/callDispatchDetach', JSON.stringify({
    ...
    $(".contextmenu").on("click", ".Set-Dispatch-Waypoint", function () { 
        const cid = $(this).data("info")
        $.post('https://drp-mdt/setDispatchWaypoint', JSON.stringify({
            callid: $(".dispatch-attached-units-container").attr("id"),
            cid: cid
        }));
    })
    ...
    $(".jail-buttons").on("click", ".jail-submit", function () {
        ...
        if (time.length > 0) {
            ...
            $.post('https://drp-mdt/jailPlayer', JSON.stringify({
                cid: cid,
                time: time
            }));
            $(".jail-inner-container").slideUp(500)
    ...
    $(".callsign-buttons").on("click", ".callsign-submit", function () {
        ...
        if (callsign.length > 2) {
            ...
            $.post('https://drp-mdt/setCallsign', JSON.stringify({
                cid: editingcallsign,
    ...
    $(".active-calls-list").on("click", ".active-calls-item", function (e) {
        ...
        if (callId && draggedElement) {
            $.post('https://drp-mdt/callDragAttach', JSON.stringify({
                callid: callId,
                cid: draggedElement
            }));
            draggedElement = 0
    ...
    window.addEventListener('message', function (event) {
        ...
        if (e.type == "show") {
            ...
            if ((BodyDisplay) == "block") {
                ...
                $.post('https://drp-mdt/dispatchNotif', JSON.stringify({
                    data: value,
                }));
            }
            $('.dispatch-items').scrollTop($('.dispatch-items')[0].scrollHeight)
...
function fidgetSpinner(page) {
    ...
    if (page == '.missing-page-container') {
        $.post('https://drp-mdt/getAllMissing', JSON.stringify({}));
    }
    if (page == '.reports-page-container') {
        $.post('https://drp-mdt/getAllReports', JSON.stringify({}));
    }
    if (page == '.stafflogs-page-container') {
        $.post('https://drp-mdt/getAllLogs', JSON.stringify({}));
    }
...
function addTag(tagInput) {
    ...
    $.post('https://drp-mdt/newTag', JSON.stringify({
...
function addWeapon(Input) {
    ...
    $.post('https://drp-mdt/newWeapon', JSON.stringify({
        id: $(".manage-profile-citizenid-input").val(),
        serialnumber: Input
    }));
}
...
function removeImage(url) {
    ...
    $.post('https://drp-mdt/removeGalleryImg', JSON.stringify({
        cid: cid,
        URL: url
    }));
}
