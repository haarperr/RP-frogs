...
Config["Offenses"] = {
    [1] = {
        ...
        [51] = { title = 'Resisting Arrest', class = 'Misdemeanor', id = 'D12', months = 15, fine = 2000, color = 'orange' },
        ...
        [146] = { title = 'Human Trafficing', class = 'Felony', id = 'M9', months = 999, fine = 0, color = 'red' },
        }
}
