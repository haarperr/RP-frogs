...
//        console.log(JSON.stringify(vehicleData))
    ...
    `
        ...
        <button id="hovercorridas" class="" aria-label="Body Health - ${vehicleData[vehicle].bodyPercent}" data-balloon-pos="up"><i  class="fas fa-car-crash"></i> </button><br><center>            <button class="waves-effect waves-light btn-small red garage-pay" data-plate="${vehicleData[vehicle].plate}"><i class="fas fa-hand-holding-usd"></i> Pay</button></center>
            ...
            if (callEntry && callEntry.type && callEntry.number && callEntry.name) {
                ...
                var element = $(`<li>
                    <div class="collapsible-header" style="font-size:12px">
                        ...
                        <span class="new badge number-badge" style="word-break: break-word;margin-left: -227px;margin-top: 29px;font-size: 15px;"">${phoneNumber}</span>
                    </div>
...
function addContact(item) {
    ...
    <h3>
    <i class="fas fa-user-slash  btn-contacts-remove" aria-label="Delete Contact" data-name="${item.name}" data-number="${item.number}"style="font-size: 22px; margin-top: 10px;margin-left: 20px; font-size: 15px"></i>
    <i class="fas fa-phone  btn-contacts-call" aria-label="Call" data-number="${item.number}"  style="margin-left: 37px;font-size: 15px;"></i>
    <i class="fas fa-comment  btn-contacts-send-message" aria-label="Send Message" data-name="${item.name}" data-number="${item.number}" style="margin-left: 37px;font-size: 15px;"></i>
    </h3>
    ...
    <div class="collapsible-header" style="font-size:12px">
        ...
        <span class="new badge number-badge" style="word-break: break-word;color: white;margin-left: -238px;margin-top: 27px;width: 167px;font-size: 15px;" data-badge-caption="">${phoneNumber}</span>
    </div>
