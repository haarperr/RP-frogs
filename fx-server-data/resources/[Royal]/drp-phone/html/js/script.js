    ...
    window.addEventListener('message', function (event) {
        ...
        switch (item.openSection) {
            ...
            case "robnotify":
                ...
                break; 
            case "transaction":
                TransactionNotify(item.pEMessages, item.pEHandle);
                break;    
            case "messagenotify":
...
function TransactionNotify(email, myHandle) {
    var notiElement = $(`</div><div class="top-notifications-email" style="max-height: 80px; display: flex;  ;"><div class="notification-container-email slideoutnotify slideinnotify" style="display: block; right: 55px;"><div class="app-bar-email"><div class="icon-twitter"><div class="emailicon" title="Email" id="icon-noti" style="background: url('https://e7.pngegg.com/pngimages/137/12/png-clipart-grand-theft-auto-v-money-investment-tiaa-finance-game-currency-text-service.png') 0% 0% / cover no-repeat;height: 18px; width: 18px; bottom: 10px; left: 2px;">
