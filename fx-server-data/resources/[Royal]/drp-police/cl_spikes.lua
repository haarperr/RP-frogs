...
Citizen.CreateThread(function()
    exports["drp-polyzone"]:AddBoxZone("armory_sandyPD1", vector3(1861.41, 3689.95, 34.28), 1.8, 3.2, {
...
AddEventHandler('drp-polyzone:enter', function(name)
    if name == "armory_sandyPD1" then
		...
		if myJob == 'police' or myJob == 'state' or myJob == 'sheriff' then
			OpenSandyPDSArmory()
            exports['drp-textui']:showInteraction("[E] Armory & Appearance")
        end
    end
end)
...
RegisterNetEvent('drp-sandyPD-menu')
AddEventHandler('drp-sandyPD-menu', function()
...
-- Citizen.CreateThread(function()
--     exports["drp-polyzone"]:AddBoxZone("evidence_sandypd", vector3(1850.07, 3694.39, 34.28), 3, 3, {
...
Citizen.CreateThread(function()
    exports["drp-polyzone"]:AddBoxZone("bennys_sandypd", vector3(1868.44, 3694.16, 33.62), 9.2, 4.8, {
        name="bennys_sandypd",
        heading=270,
		--debugPoly=true,
		-- minZ=27.67,
...
RegisterNetEvent('drp-police:AttemptBennys:SandyPD')
AddEventHandler('drp-police:AttemptBennys:SandyPD', function()
