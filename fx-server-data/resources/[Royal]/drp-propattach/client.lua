...
Citizen.CreateThread(function()
  exports["drp-binds"]:registerKeyMapping("", "Player", "Drop Prop", "+propAttachDrop", "-propAttachDrop")
...
RegisterNetEvent('drp-propattach:attach')
AddEventHandler('drp-propattach:attach', function(pPropItem, pTargetFunction)
