    ...
    while true do
        ...
        if IsControlJustPressed(0, 178) then --delete
            if vehicle ~= 0 then
                ...
                if vehiclehash == Veny.PursuitCar1 or vehiclehash == Veny.PursuitCar2 or vehiclehash == Veny.PursuitCar3 or vehiclehash == Veny.PursuitCar4 or vehiclehash == Veny.PursuitCar5 or vehiclehash == Veny.PursuitCar6 then
