            ...
            if GetDistanceBetweenCoords(playerCoords.x, playerCoords.y, playerCoords.z, enterLocation.x, enterLocation.y, enterLocation.z, true) < 1.5 then
                ...
                if IsControlJustPressed(0, 38) then
                    ...
                    if finished == 100 then
                        ...
                        GiveWeaponToPed(defender1, GetHashKey("weapon_combatpdw"), 1000, false, true)
                        GiveWeaponToPed(defender2, GetHashKey("weapon_combatpdw"), 1000, false, true)
                        GiveWeaponToPed(defender3, GetHashKey("weapon_combatpdw"), 1000, false, true)
                        GiveWeaponToPed(defender4, GetHashKey("weapon_combatpdw"), 1000, false, true)
                        GiveWeaponToPed(defender5, GetHashKey("weapon_combatpdw"), 1000, false, true)
                        GiveWeaponToPed(defender6, GetHashKey("weapon_combatpdw"), 1000, false, true)
