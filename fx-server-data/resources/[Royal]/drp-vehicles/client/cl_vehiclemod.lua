...
cfg = {
	...
	damageFactorBody = 3,					-- Sane values are 1 to 100. Higher values means more damage to vehicle. A good starting point is 10
	damageFactorPetrolTank = 17.0,				-- Sane values are 1 to 200. Higher values means more damage to vehicle. A good starting point is 64
...
local tireBurstMaxNumber = cfg.randomTireBurstInterval * 1150; 												-- the tire burst lottery runs roughly 1200 times per minute
