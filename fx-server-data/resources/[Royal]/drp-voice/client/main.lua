...
AddEventHandler('drp-voice:settingsCallback', function(cb)
	cb(Cfg)
end)
...
RegisterCommand('+cycleproximity', function()
	...
	TriggerEvent('drp-voice:setTalkingMode', voiceMode)
	TriggerEvent("drp-hud:changeRange", voiceMode)
end, false)
RegisterCommand('-cycleproximity', function()
end)
...
RegisterNetEvent('drp-voice:toggleMute', toggleMute)
...
function setVoiceProperty(type, value)
	...
	elseif type == "micClicks" then
		...
		micClicks = val
		SetResourceKvp('drp-voice_enableMicClicks', val)
	end
end
...
AddEventHandler('onClientResourceStart', function(resource)
	...
	local micClicksKvp = GetResourceKvpString('drp-voice_enableMicClicks')
	if not micClicksKvp then
		SetResourceKvp('drp-voice_enableMicClicks', tostring(true))
	else
