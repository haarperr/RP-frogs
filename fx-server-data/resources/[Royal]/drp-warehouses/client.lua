...
Citizen.CreateThread(function()
    while true do
        ...
        -- if player is near the warehouse
            ...
            local exitDistance = GetDistanceBetweenCoords(GetEntityCoords(PlayerPedId()), warehouses[i]["x"], warehouses[i]["y"], warehouses[i]["z"]-1.5, true)
            if distance <= 7.5 then
                Draw3DText(warehouses[i]["x"],warehouses[i]["y"],warehouses[i]["z"]-1.5, "Press [E] to exit")
