...
AddEventHandler("qb-casino:server:RedSell", function()
    ...
    local xItem = exports["drp-inventory"]:getQuantity("redchip")
    if xItem ~= nil then 
...
AddEventHandler("qb-casino:server:WhiteSell", function()
    ...
    local price = 1
    local user = exports["drp-base"]:getModule("Player"):GetUser(src)
    local xItem = exports["drp-inventory"]:getQuantity("whitechip")
    if xItem ~= nil then
        for k, v in pairs(Player.PlayerData.items) do 
            if Player.PlayerData.items[k] ~= nil then 
                if ItemList[Player.PlayerData.items[k].name] ~= nil then 
...
AddEventHandler("qb-casino:server:BlueSell", function()
    ...
    local price = 10
    local user = exports["drp-base"]:getModule("Player"):GetUser(src)
    local xItem = exports["drp-inventory"]:getQuantity("bluechip")
    if xItem ~= nil then
        for k, v in pairs(Player.PlayerData.items) do 
            if Player.PlayerData.items[k] ~= nil then 
                if ItemList[Player.PlayerData.items[k].name] ~= nil then 
...
AddEventHandler("qb-casino:server:BlackSell", function()
    ...
    local price = 50
    local user = exports["drp-base"]:getModule("Player"):GetUser(src)
    local xItem = exports["drp-inventory"]:getQuantity("blackchip")
    if xItem ~= nil then
        for k, v in pairs(Player.PlayerData.items) do 
            if Player.PlayerData.items[k] ~= nil then 
                if ItemList[Player.PlayerData.items[k].name] ~= nil then 
...
AddEventHandler("qb-casino:server:GoldSell", function()
    ...
    local price = 100
    local user = exports["drp-base"]:getModule("Player"):GetUser(src)
    local xItem = exports["drp-inventory"]:getQuantity("goldchip")
    if xItem ~= nil then
        for k, v in pairs(Player.PlayerData.items) do 
            if Player.PlayerData.items[k] ~= nil then 
                if ItemList[Player.PlayerData.items[k].name] ~= nil then 
