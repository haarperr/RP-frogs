...
description "rpfrogs-blackjack, made by Robbster as DiamondBlackjack and modified by Greenlio."
...
client_scripts {
	...
	"client/cl_casinoteleporter.lua",
}

server_script "server/sv_blackjack.lua"
