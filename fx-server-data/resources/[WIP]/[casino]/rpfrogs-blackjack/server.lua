...
--[===[
	exports["rpfrogs-blackjack"]:SetGetChipsCallback(function(source)
		return 0 -- [[ return money ]]
	end)

	exports["rpfrogs-blackjack"]:SetTakeChipsCallback(function(source, amount)
		--[[ money = money - amount? ]]
	end)

	exports["rpfrogs-blackjack"]:SetGiveChipsCallback(function(source, amount)
		--[[ money = money + amount? ]]
	end)
--]===]
