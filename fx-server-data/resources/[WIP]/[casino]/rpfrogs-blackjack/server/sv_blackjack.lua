...
function tryTakeChips(source,amount)
    -- i am sleep deprived bro 
    if TriggerClientEvent('inventory:removeItem', source, "casinochips", amount) then
        return true
    else
        return false
    end
...
function giveChips(source,amount)
    TriggerClientEvent('inventory:addItem', source, "casinochips", amount)
end
