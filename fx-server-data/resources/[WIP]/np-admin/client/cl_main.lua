...
RegisterNUICallback('np-admin:update:vehicle:cl', function(data, cb)
  TriggerServerEvent('np-admin:update:vehicle', source, data.licenseplate, data.garagename)
end)
...
RegisterNUICallback('devmode', function(data, cb)
  TriggerEvent('np-admin:client:ToggleDevmode', data.returnvalue)
  devmodeToggle = data.returnvalue
end)

RegisterNUICallback('debugmode', function(data, cb)
  TriggerEvent('np-admin:client:ToggleBugmode', data.returnvalue)
