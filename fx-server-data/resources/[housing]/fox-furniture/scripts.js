$(document).ready(function(){
  ...
  $(".btnClose").click(function(){
      closeMain()
      $.post('http://drp-furniture/close', JSON.stringify({}));
  });
  ...
  $(".btnMove").click(function(){
      ...
      $(".SelectObject").css("display", "none");
      $.post('http://drp-furniture/scanObject', JSON.stringify({}));
  });

  $(".btnFree").click(function(){
      $(".wrapSelectObjects").css("display", "none");
      $(".SelectObject").css("display", "none");
      $.post('http://drp-furniture/FreeCam', JSON.stringify({}));
  });
  ...
  $(".btnModify").click(function(){
      $(".wrapSelectObjects").css("display", "none");
      $(".SelectObject").css("display", "none");
      $.post('http://drp-furniture/newObject', JSON.stringify({}));
  ...
  $(".btnDelObj").click(function(){
    $.post('http://drp-furniture/DelSelectedObj', JSON.stringify({}));
  });
  ...
  $(".btnDel").click(function(){
      ...
      $.post('http://drp-furniture/DelObj', JSON.stringify({}));
  });

  $(".btnNextObj").click(function(){
    $.post('http://drp-furniture/NextObj', JSON.stringify({}));
  });
  $(".btnPrevObj").click(function(){
    $.post('http://drp-furniture/PrevObj', JSON.stringify({}));
  });
    ...
    if(item.redoCSS === true) {
      $('select').each(function(){
          ...
          $listItems.click(function(e) {
              ...
              $.post('http://drp-furniture/selectObject', JSON.stringify({selectObject: $this.val()}));
          });
