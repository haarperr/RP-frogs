...
$(document).ready(function() {
    ...
    document.onkeyup = function(data) {
        if (data.which == 27) {
            $.post('http://drp-banking/close', JSON.stringify({}));
        }
    };
    // Handle Button Presses
    $(".btnWithdraw").click(function() {
        $.post('http://drp-banking/withdraw', JSON.stringify({}));
    });
    ...
    $("#Withdraw").click(function() {
        ...
        $.post('http://drp-banking/withdrawSubmit', JSON.stringify({ amount: amount, reason: comment }));
    ...
    $("#Transfer").click(function() {
        ...
        $.post('http://drp-banking/transferSubmit', JSON.stringify({ toPlayer: playerid, amount: amount, reason: comment }));
        addlog(amount, comment, true)
    ...
    $("#Deposit").click(function() {
        ...
        $.post('http://drp-banking/depositSubmit', JSON.stringify({ amount: amount, reason: comment }));
    ...
    $("#bussinessdepositaccept").click(function() {
        ...
        $.post('http://drp-banking/depositBussinessSubmit', JSON.stringify({ amount: amount, reason: comment }));
    ...
    $("#bussinessWithdrawaccept").click(function() {
        ...
        $.post('http://drp-banking/withdrawBussinessSubmit', JSON.stringify({ amount: amount, reason: comment }));
