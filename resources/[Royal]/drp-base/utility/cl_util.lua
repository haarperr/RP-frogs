function DRP.Util.MissionText(self, text, time)
...
function DRP.Util.DrawText(self, text, font, centre, x, y, scale, r, g, b, a)
    SetTextFont(font)
    SetTextProportional(0)
    SetTextScale(scale, scale)
    SetTextColour(r, g, b, a)
...
function DRP.Util.DrawText3D(self, x,y,z, text)
...
function DRP.Util.RotationToDirection(self,rotation)
...
function DRP.Util.ScreenRelToWorld(self,camPos,camRot,coord)

      local distance = 1000.0
      local camForward = DRP.Util.RotationToDirection(self,camRot);
      ...
      local camRight = DRP.Util.RotationToDirection(self,rotRight) - DRP.Util.RotationToDirection(self,rotLeft);
      local camUp = DRP.Util.RotationToDirection(self,rotUp) - DRP.Util.RotationToDirection(self,rotDown);
...
DRP.Util.GetPlayersInArea = function(coords, area)
	return enumerateInArea(DRP.Util.GetPlayers(), coords, area)
end

DRP.Util.GetPlayers = function()
	local maxPlayers = 24
	local players    = {}
