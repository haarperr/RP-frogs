...
Citizen.CreateThread(function()
  ...
  -- exports["drp-polyzone"]:AddBoxZone("casino_entrance", vector3(934.66, 46.54, 81.11), 4.4, 6.2, {
  --   heading=10,
  --   minZ=80.1,
  --   maxZ=82.9,
  --   data = {
  ...
  --   },
  -- })
  -- exports["drp-polyzone"]:AddBoxZone("casino_exit", vector3(1089.83, 206.84, -49.0), 4, 4, {
  --   heading=0,
  --   minZ=-50.2,
  --   maxZ=-47.2,
  --   data = {
  ...
  --   },
  -- })
  exports["drp-polyzone"]:AddBoxZone("casino_entrance", vector3(930.0, 43.48, 81.1), 12.2, 10, {
    heading=328,
    minZ=79.9,
    maxZ=83.9,
    data = {
  ...
  exports["drp-polyzone"]:AddBoxZone("casino_exit", vector3(921.06, 48.99, 81.1), 10.8, 10, {
    heading=328,
    minZ=79.7,
    maxZ=83.7,
    data = {
  ...
  exports["drp-polyzone"]:AddBoxZone("casino_post_gate", vector3(1122.36, 240.28, -50.44), 10.8, 5.0, {
    heading=42,
    minZ=-51.44,
    maxZ=-49.04,
    data = {
  ...
  exports["drp-polyzone"]:AddBoxZone("casino_betting_screen", vector3(1100.96, 256.81, -51.24), 20, 25.6, {
    heading=306,
    minZ=-52.04,
    maxZ=-48.04,
    data = {
...
RegisterNetEvent("drp-casino:entitySetSwap", function(set)
...
-- }
-- RegisterNetEvent("drp-casino:entitySetSwapUtil", function(sets)
...
AddEventHandler("drp-casino:enterPenthouse", function()
  TriggerEvent("drp-casino:elevatorExitCasino")
  local interiorId = GetInteriorAtCoords(968.58,46.92,116.17)
  ActivateInteriorEntitySet(interiorId, "set_pent_creampie")
  RefreshInterior(interiorId)
end)

AddEventHandler("drp-casino:betting:interiorSwap", function(pArgs)
  ...
  TriggerServerEvent("ab-casino:interiorSwap", pArgs[1])
end)
