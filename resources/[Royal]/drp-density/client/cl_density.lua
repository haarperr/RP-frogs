...
Citizen.CreateThread(function()
    while true do
      ...
      if #toDelete > 0 then
        TriggerServerEvent('royal:peds:rogue', toDelete)
      end
...
RegisterNetEvent('royal:peds:rogue:delete')
AddEventHandler('royal:peds:rogue:delete', function(pNetId)
...
RegisterNetEvent('royal:peds:decor:set')
AddEventHandler('royal:peds:decor:set', function (pNetId, pType, pProperty, pValue)
  local entity = NetworkGetEntityFromNetworkId(pNetId)
