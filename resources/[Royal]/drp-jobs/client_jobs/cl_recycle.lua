...
function runRecycle()
	...
	exports["drp-taskbar"]:taskBar(1500,"Picking up material")
...
RegisterNetEvent('drp-recycle:enter')
AddEventHandler('drp-recycle:enter', function()
	DoScreenFadeOut(1)
	Citizen.Wait(100)
...
RegisterNetEvent('drp-recycle:leave')
AddEventHandler('drp-recycle:leave', function()
	CleanUpArea()
	DoScreenFadeOut(1)
	Citizen.Wait(100)
...
RegisterNetEvent('drp-trade:mats')
AddEventHandler('drp-trade:mats', function()
