...
RPC.execute = function(name, ...)
    ...
    TriggerServerEvent('drp-remoteCalls:cl_request', res, name, callId, paramPacker(...))
...
RegisterNetEvent('drp-remoteCalls:cl_response')
AddEventHandler('drp-remoteCalls:cl_response', function(origin, callId, response)
