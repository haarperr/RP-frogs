	...
	while true do
		...
		for k,v in pairs (pedList) do
			...
			if dist < 20.0 and hasAlreadyEntered == false then
				TriggerEvent('drp-peds:nearPed', v.model, v.coords, v.heading, v.gender, v.animDict, v.animName)
...
AddEventHandler('drp-peds:nearPed', function(model, coords, heading, gender, animDict, animName)
	RequestModel(model)
...
Config.PedList = {
	...
	{
		model = "mp_m_securoguard_01",
		coords = vector3(291.0989074707,6519.9033203125,29.785400390625),
		heading = 87.5884, 
		gender = "male", 
	},
}
