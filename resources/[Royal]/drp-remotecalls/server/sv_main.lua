...
RegisterNetEvent('drp-remotecalls:cl_request')
AddEventHandler('drp-remotecalls:cl_request', function(origin, name, callId, params)
    local response
    local src = source
    ...
    TriggerClientEvent('drp-remotecalls:cl_response', src, origin, callId, response)
end)