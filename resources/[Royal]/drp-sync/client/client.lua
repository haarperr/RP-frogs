TriggerServerEvent("royal:sync:player:ready")
...
function syncNative(name, netEntity, options, ...)
    TriggerServerEvent("drp-sync:executeSyncNative", name, netEntity, options, table.pack(...))
end
exports("syncNative", syncNative)

RegisterNetEvent("drp-sync:clientExecuteSyncNative")
AddEventHandler("drp-sync:clientExecuteSyncNative", function(native, netEntity, options, args)
