...
Citizen.CreateThread(function()
    RegisterKeyMapping("+playerTarget", "Bowling", "keyboard", "X") --Removed Bind System and added standalone version
    ...
    while true do
        ...
        if entity and entityType ~= 0 then
            if entity ~= CurrentTarget then
                ...
                TriggerEvent('drp-task:inFront', CurrentTarget, entityType, entityCoords)
            end
        elseif CurrentTarget then
            CurrentTarget = nil
            TriggerEvent('drp-task:inFront', CurrentTarget)
        end
