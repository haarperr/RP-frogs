...
RegisterNetEvent("drp-ui:open-application")
AddEventHandler("drp-ui:open-application", openApplication)
...
function closeApplication(app, data)
    ...
    TriggerEvent("drp-ui:application-closed", app, { fromEscape = false })
end
